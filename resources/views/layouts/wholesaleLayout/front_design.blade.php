...
<head>
    ...
    <title>Lord Bhuddha Himalayan</title>
    ...
    <link rel="apple-touch-icon-precomposed" href="{{asset ('img/frontend_images/eye.svg') }}">
...
<body>
	...
	@include('layouts.wholesaleLayout.front_header')
	
@yield('content')
	
@include('layouts.wholesaleLayout.front_footer')
