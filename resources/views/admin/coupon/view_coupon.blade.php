            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td class="center"><a href="{{url('/admin/edit-coupon/'.$coupon->id)}}" class="btn btn-primary btn-mini">Edit</a> | <a id ="delCat" href="{{url('/admin/delete-coupon/'.$coupon->id)}}" class="btn btn-danger btn-mini">Delete</a></td>
                </tr>
                @endforeach
