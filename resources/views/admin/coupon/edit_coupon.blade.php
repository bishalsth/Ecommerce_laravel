...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Coupon</a> <a href="#" class="current">Validation</a> </div>
    <h1>Edit Coupon</h1>
          ...
          <div class="widget-content nopadding">
            <form  class="form-horizontal" method="post" action="{{url('/admin/edit-coupon/'.$couponDetails->id)}}" name="add_coupon" id="add_coupon" > {{ csrf_field()}}
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="number" name="amount" value="{{$couponDetails->amount}}" id="amount" min="0" required>
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="expiry_date" value="{{$couponDetails->expiry_date}}" id="expiry_date" required>
                </div>
              </div>
              ...
              <div class="form-actions">
                <input type="submit" value="Edit Coupon" class="btn btn-success" id="add_coupon">
              </div>
            </form>
          </div>
        </div>
